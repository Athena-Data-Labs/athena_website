...
export const caseStudies: CaseStudy[] = [
  {
    ...
    relatedFieldNoteSlugs: ["privacy-first-architecture-security", "executive-dashboard-design", "aws-account-per-app-migration"],
  },
  {
    ...
    relatedFieldNoteSlugs: ["privacy-first-architecture-security", "practical-forecasting-small-business", "aws-account-per-app-migration"],
  },
  {
