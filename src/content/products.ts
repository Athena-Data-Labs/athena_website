...
export const products: Product[] = [
  {
    ...
    overview: [
      ...
      "It runs on a phone and a Mac as well as in a browser, and that is not a checkbox. The decisions it informs are rarely made at a desk. A founder in a meeting, an operator on a site visit, a partner waiting at an airport: all three need the same current numbers. They should be able to answer the question in front of them rather than promise to look it up when they get back.",
  ...
  },
  {
    ...
    overview: [
      "MyBudgetNerd is a consumer finance product we designed, built, and shipped to the App Store, now a subscription SaaS with active subscribers. Upload a bank statement and it parses every transaction, then categorizes them with a machine-learning pipeline. The result goes to the Oracle: an analysis engine that flags anomalies, projects each category forward, and explains in plain language what changed since last month.",
  ...
  },
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "It is the opt-in half of partner matching. Thera already finds subcontractor candidates in public federal award data; a network listing puts your own company into that result for other members. Publish one and it is matched on your NAICS codes and the states you serve. It then surfaces inside another member's partner search for a live notice, ranked above the cold leads and carrying the contact details you chose to list. One field on it is not self-written: give Thera your UEI and it stores your federal award record from USAspending, so a prime is reading something the government recorded rather than something you typed. It is included in the subscription and in the trial, it stays off until you switch it on, and unpublishing removes you from every search immediately.",
      },
      {
