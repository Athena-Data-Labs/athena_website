...
export const services: Service[] = [
  {
    ...
    workedExample: {
      ...
      body:
        "A finance workbook is connected, whether in OneDrive, in Google Sheets, or uploaded outright, and the columns are mapped automatically. The result is a live command center, with metrics defined once and computed the same way on the desk and on the phone. We built that pipeline for ourselves first, then shipped it as a product, which is the only reason we can show you the inside of it.",
