  ...
  return (
    ...
    >
      <Seo
        ...
        description="Consulting in data analytics, AI solutions, executive dashboards, forecasting, Excel automation and operations research. Production-grade delivery."
        path="/services"
      ...
      <section className="border-b border-foreground/[0.06] panel py-12 md:py-16">
        <div className="container mx-auto px-6">
          <div className="grid gap-px border border-foreground/[0.07] bg-foreground/[0.05] md:grid-cols-2 lg:grid-cols-3">
